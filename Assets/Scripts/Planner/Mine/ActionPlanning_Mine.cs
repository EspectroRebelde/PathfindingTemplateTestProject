...
public class ActionPlanning_Mine
{
    ...
    public enum ActionType
    {
        ...
        ACTION_TYPE_ATTACK_POINT            = (ACTION_TYPE_ATTACK_NORMAL_POINT | ACTION_TYPE_ATTACK_WEAK_POINT | ACTION_TYPE_ATTACK_SEVERABLE_PART | ACTION_TYPE_ATTACK_BREAKABLE_PART),
        ACTION_TYPE_ATTACK_SET              = (ACTION_TYPE_ATTACK | ACTION_TYPE_ATTACK_POINT),
        ...
        ACTION_TYPE_EQUIP_SET               = (ACTION_TYPE_EQUIP_WEAPON_LONSWORD | ACTION_TYPE_EQUIP_WEAPON_HAMMER | ACTION_TYPE_EQUIP_WEAPON_LANCE | ACTION_TYPE_EQUIP_WEAPON_SWORD),
